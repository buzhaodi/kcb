...
class Article extends LogicBase
{
    ...
    public function getWhere($data = [])
    {
        ...
        $where = [];
//        dump($data);
//        if(!empty($data['search_data_type'])){
//            dump($data['search_data_type']);
//        }

        !empty($data['search_data_type']) && $where['category_id'] = ['in',$data['search_data_type']];
        !empty($data['search_data']) && $where['a.name|a.describe|a.code'] = ['like', '%'.$data['search_data'].'%'];
